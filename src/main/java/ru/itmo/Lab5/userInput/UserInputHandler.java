...
public class UserInputHandler {
  public void readUserInput(CollectionManager collectionManager) {
    ArrayList<String> args = new ArrayList<String>();
    String[] command;
    Scanner scanner = new Scanner(System.in);
    Queue<String> commandBuffer = new ArrayDeque<>();
    boolean exit = false;
    while (exit == false) {
      System.out.print("> ");
      ...
      switch (command[0]) {
        ...
        case "count_greater_than_cave":
          ...
          args.clear();
          args.add(command[1]);
          CountGreaterThanCave countGreaterThanCave = new CountGreaterThanCave(collectionManager);
        ...
        case "print_field_descending_character":
          PrintFieldDescendingCharacter printFieldDescendingCharacter = new PrintFieldDescendingCharacter(
              collectionManager);
